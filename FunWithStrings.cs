...
// Uncomment function(s) to run when running program
...
static void StringConcatenation()
{
    ...
    string s3 = s1 + s2;
    // The + symbol automatically calls String.Concat, so the below is what is being called above
...
static void VerbatimStrings()
{
    ...
    // The follwing string is printed verbatim, all escape characters are displayed
    Console.WriteLine(@"C:\MyApp\bin\Debug");

    // White space is preserved with verbatim strings (use 2 double quotes to insert 1 double quote)
    string myLongString = @"This is a very             very                     very                       very             long string...";
    Console.WriteLine(myLongString);
    Console.WriteLine(@"Cerebus said ""Darrr! Pret-ty sun-sets""");

    // You can still user interpolation within verbatim strings by using prefix $@ or @$
    string interp = "interpolation";
    string myLongString2 = $@"This is a very              very             long string with {interp}";
    Console.WriteLine(myLongString2);
    string myLongString3 = @$"This is a very                  very              long string with {interp}";
