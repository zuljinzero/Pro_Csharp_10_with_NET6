...
static void DefaultDeclarations()
{
    ...
    // Sets myInt to the default value of its type (int = 0)
    int myInt = default;
...
{
    Console.WriteLine("=> Using new to create variables with C# 9:");
    bool b = new();
    int i = new();
    double d = new();
    DateTime dt = new();
...
{
    Console.WriteLine("=> Bool Functionality:");
...
static void ParseFromStrings()
{
    ...
    char c = Char.Parse("w");
    Console.WriteLine("Valu of c: {0}", c);
    Console.WriteLine();
}
...
static void UseDatesAndTimes()
{
    ...
    // DateOnly is a SQL Server Date type
    DateOnly d = new DateOnly(2021, 07, 21);
    Console.WriteLine(d);

    // TimeOnly is a SQL Server Time type
...
{
    // Updated in C# 7.0, you can use _ to seperate digits in long sequences without interfering with the value
    // For the purpose of visibility
    Console.WriteLine("=> Use Digit Separators:");
    Console.Write("Integer:");
    Console.WriteLine(123_456);
    Console.Write("Long:");
    Console.WriteLine(123_456_798L);
    Console.Write("Float:");
    ...
    // Updated in C# 7.2, Hex can begin with _
    Console.Write("Hex:");
...
{
    // Updated in C# 7.2, Binary can begin with _
